  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-20 left-10 w-32 h-32 rounded-full bubble-shimmer bubble opacity-40 blur-lg bg-gradient-to-b from-purple-700 to-purple-900" style={{ animationDelay: '0s' }} />
        <div className="absolute top-40 right-20 w-24 h-24 rounded-full bubble-shimmer bubble opacity-30 blur-lg bg-gradient-to-b from-purple-700 to-purple-900" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-40 left-1/4 w-40 h-40 rounded-full bubble-shimmer bubble opacity-35 blur-lg bg-gradient-to-b from-purple-700 to-purple-900" style={{ animationDelay: '4s' }} />
        <div className="absolute bottom-60 right-1/3 w-20 h-20 rounded-full bubble-shimmer bubble opacity-25 blur-lg bg-gradient-to-b from-purple-700 to-purple-900" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/3 right-10 w-28 h-28 rounded-full bubble-shimmer bubble opacity-30 blur-lg bg-gradient-to-b from-purple-700 to-purple-900" style={{ animationDelay: '3s' }} />
      </div>
      ...
      {/* Features Section */}
      <section className="container mx-auto px-4 pb-16 md:pb-20 relative">
