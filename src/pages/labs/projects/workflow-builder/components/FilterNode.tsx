...
import { Filter, Settings, Plus, X, MoreHorizontal } from 'lucide-react';
...
const FilterNode = memo<NodeProps>(({ id, data, selected }) => {
  ...
  const filteredCount = nodeData.outputData?.length || 0;
  const inputCount = nodeData.inputData?.length || 0;
      ...
      >
        ...
        <div className="p-4 min-w-[200px]">
          ...
          <div className="space-y-2">
            ...
            {nodeData.isExecuted && inputCount > 0 && (
              <Badge variant="secondary" className="text-xs">
                {filteredCount} / {inputCount} items
              </Badge>
            )}
            ...
            {nodeData.isExecuted && (
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground">
                  {nodeData.executionError ? 'Failed' : 'Filtered'}
                </span>
              </div>
            )}
          </div>
        ...
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground">
              Items that match these conditions will be kept in the output. All other items will be filtered out.
            </div>
